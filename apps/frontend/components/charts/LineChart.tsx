...
import type { ChartSpec, DataItem } from "@/types/chart-types";
...
export function LineChartComponent({ spec }: LineChartComponentProps) {
  if (!spec.data || spec.data.length === 0) {
    console.error("LineChartComponent: Chart data is empty or undefined");
    return null;
  }

  if (spec.chartType !== 'line') {
    console.error(`LineChartComponent: Expected chart type 'line', got '${spec.chartType}'`);
    return null;
  }
